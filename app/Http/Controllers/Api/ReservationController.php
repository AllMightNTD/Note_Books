...
class ReservationController extends BaseController
{
    ...
    public function historyReservation(Request $request)
    {
        ...
        return [
            'data' => Reservation::query()
                ...
                ->whereHas('restaurant', function ($query) use ($keyWord) {
    ...
    public function historyReservationManager(Request $request)
    {
        ...
        return [
            'data' => Reservation::query()
                ...
                ->with(['restaurant', 'user']) // Optionally include the restaurant data
                ->paginate($perPage)
        ];
    }
    ...
    {
        $data = Reservation::query()->where('id', $id)->with(['restaurant'])->first();
        return [
            'data' => $data
